...
<!--
  ...
  nom du SLD : geo_commune_hors_rm_etq

  couche source dans la base :  cadastre_qgis.geo_commune_hors_rm
  layer cible du style       :  ref_cad:geo_commune_hors_rm

  objet : étiquettes des noms des communes hors Rennes Métropole

  Historique des versions :
  date        |  auteur              |  description
  21/08/2019  |  Maël REBOUX         |  version initiale copié du style geo_commune_etq
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>geo_commune_hors_rm_etq</se:Name>
      <se:Description>
        <se:Title>Noms des communes hors Rennes Métropole</se:Title>
        <se:Abstract>Noms des communes hors Rennes Métropole</se:Abstract>
      </se:Description>
      <se:FeatureTypeStyle>
