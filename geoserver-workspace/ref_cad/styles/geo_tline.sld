...
<!--
  ...
  nom du SLD : geo_tline

  couche source dans la base :  cadastre_qgis:geo_tline
  ...
  21/08/2019  |  Maël REBOUX         |  renommage du style : obj_lin_divers -> geo_tline
...
<StyledLayerDescriptor version="1.1.0"
  ...
  <NamedLayer>
    <se:Name>ref_cad:geo_tline</se:Name>
    <UserStyle>
      <se:Name>geo_tline</se:Name>
      <se:Description>
