...
<!--
  ...
  nom du SLD : geo_parcelle_fond
  
  couche source dans la base :  cadastre_qgis.geo_parcelle
  layer cible du style       :  ref_cad:geo_parcelle
  
  objet : fond des parcelles
  
  Historique des versions :
  date        |  auteur              |  description
  21/08/2019  |  Maël REBOUX         |  version initiale reprise de edi_parc_plg
...
xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    ...
    <UserStyle>
      <se:Name>geo_parcelle_fond</se:Name>
        <se:Description>
          <se:Title>geo_parcelle_fond</se:Title>
