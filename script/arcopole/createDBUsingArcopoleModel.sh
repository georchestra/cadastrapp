...
#   1.4      | Maël Reboux     | 01/06/2016 | Capabilities to use a non local target database
#////////////////////////////////////////////////////////////////////
...
if [ "$#" -ne 9 ]; then
  ...
  arcopoleDBHost=postgis-bdu
  arcopoleDBName=bdu
  arcopoleDBSchema=cadastre
  arcopoleDBUser=xxxxxxxxxxxxxx
  arcopoleDBPassword=xxxxxxxxxxxxxx
else
