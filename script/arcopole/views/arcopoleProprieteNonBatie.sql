...
left join #DBSchema_arcopole.dgi_exopev pevx on pevx.id_pev=pev.id_pev'::text) proprietenonbatie(id_local character varying(16), lot character varying(255), comptecommunal character varying(12), dnupro character varying(12), ccodep text, ccocom text, codir text, ccopre text, ccosec text, dnupla integer, jdatat character varying(8), dnvoiri character varying(4), dindic character varying(1), natvoie character varying(4), dvoilib character varying(30), ccoriv character varying(4), dparpi character varying(4), gpafpd character varying(1), ccostn character varying(1), ccosub character varying(2), cgrnum character varying(2), dsgrpf character varying(2), dclssf character varying(2), cnatsp character varying(5), dcntsf character varying(9), drcsuba character varying(10), pdl character varying(3), dnulot character varying(7), ccolloc character varying(2), gnextl character varying(2), jandeb character varying(4), janimp character varying(4), fcexb character varying(9), pexb character varying(5), dreflf character varying(9));
